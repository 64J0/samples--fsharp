...
let getStudentIndex (student: string) : int =
    studentDisposition |> List.findIndex (fun s -> s.ToString() = student)
...
let plants (diagram: string) (student: string) : list<Plant> = getStudentPlants diagram student
